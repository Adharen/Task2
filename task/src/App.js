  ...
  return (
    <>
      <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", height: "70px", background: "#ddd", marginBottom: "20px" }}>
        <h3 style={{ marginLeft: "10px", color: "blue" }}>WebMaker</h3>
        <div>
          <button onClick={getdata} style={{ background: "green", padding: "5px", border: "0px", outline: "none", color: "#fff", margin: "20px" }} >GET DATA</button>
          <button onClick={clear} style={{ background: "red", padding: "5px", border: "0px", outline: "none", color: "#fff", margin: "20px" }} >CLEAR DATA</button>
        </div>
      </nav>
